  ...
  return (
    <section className='about'>
      ...
      <div className='descriptions'>
        <div className='desc' data-aos='zoom-in-right' data-aos-easing='ease-out-cubic' data-aos-duration='1500'>
          <h3>Web Developer</h3>
          <p>
        ...
        <div className='desc' data-aos='zoom-in-left' data-aos-easing='ease-out-cubic' data-aos-duration='1500'>
          <h3>Skills</h3>
          <p>
